...
public class Start {
    public static void main(String[] args) {
        ...
        //chiamando il metodo e passando due valori interi per ritornare se sono uguali
        boolean risultato = confronti(a,b);

        //output in video con il risultato dell metodo
        System.out.println("Il valore della variabile A ("+a+") e B ("+b+") sono uguali? "+risultato);
    }

    //creazione di un metodo per confrontare due numeri passati come parametri
    public static boolean confronti(int a, int b) {
        //confronto dei due numeri ricevuti come parametro e ritorno in booleano per scoprire se è true (uguale) o false (diverso)
        return a==b;
    }
}
